  ...
  Widget _handleMenu() {
    return Container(
      ...
      child: ListView(
        ...
        children: [
          _itemMenuBuilder(
              'Minhas Chaves', FontAwesomeIcons.key, AppRoutes.PIXKEYS),
          _itemMenuBuilder(
              'Qr-Code', FontAwesomeIcons.qrcode, AppRoutes.PIXQRCODE),
        ],
      ),
    );
  }
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color:
                            controller.hover ? Colors.white : Colors.deepPurple,
